...
/**
 * Service for detecting conversation topics from Instagram message text
 * Uses keyword matching to classify messages into predefined topics
 * Keywords are slightly more informal for Instagram's casual nature
 */
@Injectable()
export class TopicDetectionService {
  private readonly keywordMap: Record<string, string[]> = {
    ...
    support: [
      ...
      'roto', 'damaged', 'doesn\'t work', 'not', 'no', '😭', '😢',
      'bad', 'terrible', 'peor'
    ],
    product: [
